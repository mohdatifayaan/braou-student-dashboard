...
var HttpProtocol = class extends SerdeContext {
  ...
  setHostPrefix(request, operationSchema, input) {
    ...
    if (opTraits.endpoint) {
      let hostPrefix = (_b2 = opTraits.endpoint) == null ? void 0 : _b2[0];
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./index.browser-PGA6LQS7.js");
...
var FromStringShapeDeserializer = class extends SerdeContext {
  ...
  read(_schema, data2) {
    ...
    if (ns.isBlobSchema()) {
      return (((_a3 = this.serdeContext) == null ? void 0 : _a3.base64Decoder) ?? fromBase64)(data2);
    }
  ...
  base64ToUtf8(base64String) {
    var _a3, _b2;
    return (((_a3 = this.serdeContext) == null ? void 0 : _a3.utf8Encoder) ?? toUtf8)((((_b2 = this.serdeContext) == null ? void 0 : _b2.base64Decoder) ?? fromBase64)(base64String));
  }
};
...
var HttpInterceptingShapeDeserializer = class extends SerdeContext {
  ...
  read(schema, data2) {
    ...
    const ns = NormalizedSchema.of(schema);
    const traits = ns.getMergedTraits();
    const toString = ((_a3 = this.serdeContext) == null ? void 0 : _a3.utf8Encoder) ?? toUtf8;
    ...
    switch (typeof value) {
      case "object":
        ...
        if (ns.isBlobSchema() && "byteLength" in value) {
          this.stringBuffer = (((_a3 = this.serdeContext) == null ? void 0 : _a3.base64Encoder) ?? toBase64)(value);
          return;
        }
...
// node_modules/@aws-sdk/checksums/dist-es/flexible-checksums/stringUnionSelector.js
var SelectorType2;
(function(SelectorType3) {
  SelectorType3["ENV"] = "env";
  SelectorType3["CONFIG"] = "shared config entry";
...
var selectChecksumAlgorithmFunction = (checksumAlgorithm, config) => {
  ...
  switch (checksumAlgorithm) {
    ...
    case ChecksumAlgorithm.CRC32:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC32) ?? getCrc32ChecksumAlgorithmFunction();
    case ChecksumAlgorithm.CRC32C:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC32C) ?? AwsCrc32c;
    case ChecksumAlgorithm.CRC64NVME:
      if (typeof crc64NvmeCrtContainer.CrtCrc64Nvme !== "function") {
        return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC64NVME) ?? Crc64Nvme;
      }
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC64NVME) ?? crc64NvmeCrtContainer.CrtCrc64Nvme;
...
var ListBucketsCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command2, cs, config, o2) {
  return [
    getEndpointPlugin(config, Command2.getEndpointParameterInstructions()),
    getThrow200ExceptionsPlugin(config)
  ];
